...
P=gsw_p_from_z(-3860,-60);    %[bar] pressure
...
dtNH4w=0; %[mol/m3] typical for deep sea oxic bottom waters (Archer et al., 2002)
...
dMgw=0.06667./40.087.*(S./1.80655)*rho_sw;  %[mol/m3] Mg, computed from salinity using Riley CG(1967)
